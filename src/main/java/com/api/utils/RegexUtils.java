...
public class RegexUtils {
    ...
    public static boolean isLink(String link) {
        return matches(link.trim(), REGEX_LINK);
    }
    ...
    public static boolean isMobile(String mobile) {
        return matches(mobile.trim(), REGEX_MOBILE);
    }
    ...
    public static boolean isEmail(String email) {
        return matches(email.trim(), REGEX_EMAIL);
    }
    ...
    public static boolean isChinese(String chinese) {
        return matches(chinese.trim(), REGEX_CHINESE);
    }
    ...
    public static boolean isIdCard(String idCard) {
        return matches(idCard.trim(), REGEX_ID_CARD);
    }
    ...
    public static boolean isIp(String ip) {
        return matches(ip.trim(), REGEX_IP_ADDRESS);
    }
    ...
    public static boolean isNumber(String number) {
        return matches(number.trim(), REGEX_NUMBER_INT) || matches(number, REGEX_NUMBER_FLOAT);
    }
}
